...
package za.co.absa.hyperdrive.transformer.data.impl.select

import org.apache.spark.sql.DataFrame
import za.co.absa.hyperdrive.transformer.data.StreamTransformer

private[data] class ColumnSelectorStreamTransformer(val columns: Seq[String]) extends StreamTransformer {
