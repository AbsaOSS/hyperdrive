...
class AddEnceladusColumnsTransformerLoader extends StreamTransformerFactoryProvider {
  override def getComponentFactory: StreamTransformerFactory = AddEnceladusColumnsTransformer
}
